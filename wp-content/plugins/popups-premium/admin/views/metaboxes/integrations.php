...
if ( !defined( 'ABSPATH' ) ) exit;?>
	...
	<table class="form-table">
		...
		<tr valign="top" class="optin_opts optin_theme <?php echo ( !empty($opts['optin']) ) ? 'visible' : '';?>">
			...
			<td>
				<div class="optin_themes">
					...
					<div class="theme <?php echo $opts['optin_theme'] == 'bar' ?'selected':'';?>" data-theme="bar">
						<div class="thumb"><img src="<?php echo SPUP_PLUGIN_URL?>/admin/assets/img/top-bar.png" alt=""/></div>
						BOTTOM/TOP BAR
					</div>
				</div>
		...
		<tr valign="top" class="optin_opts optin_success <?php echo ( !empty($opts['optin']) ) ? 'visible' : '';?>">
			...
			<td>
				<input type="text" id="spu_optin_success" name="spu[optin_success]" class="widefat" value="<?php echo htmlentities($opts['optin_success']);?>"/>
