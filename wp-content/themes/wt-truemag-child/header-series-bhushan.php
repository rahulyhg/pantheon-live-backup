...
if($series_header_style=='banner'){
	...
	?>
        ...
        <div class="row">
        <div id="series_pre_poster" class="col-md-2">&nbsp;</div>
        <div id="series_poster" class="col-md-4"
        <?php if($cat_height){ echo 'style="height:'.$cat_height.'px"';} ?>>
		<?php if($cat_link){ echo '<a href="'.$cat_link.'">';} ?>
		<?php if(isset($cat_img)&&$cat_img){ echo '<img src="'.$cat_img.'" />';} ?>
		<?php if($cat_link){ echo '</a>';} ?>
	</div>
        <div id="series_description" class="col-md-4">
                <?php 
                        $taxonomy_description = term_description($series_id); 
                        echo "<span style='color:black'>$taxonomy_description</span>";
                ?>
	</div>
        <div id="series_post_description" class="col-md-2">&nbsp;</div>
	<?php
