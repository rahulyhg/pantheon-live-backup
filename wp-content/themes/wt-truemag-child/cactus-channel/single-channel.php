                                  ...
                                  <div class="navi-channel">                                        	
                                      <div class="navi pull-left">
                                          <div class="navi-content">
                                              <div class="navi-item <?php if( (!isset($_GET['view']) &&  ($cpage =='')) || ( (isset($_GET['view']) && $_GET['view'] =='playlists') &&  ($cpage =='')) || ((isset($_GET['view']) && $_GET['view'] =='')&&  ($cpage ==''))){?> active <?php }?>"><a href="<?php echo add_query_arg( array('view' => 'playlists'), get_the_permalink() ); ?>" title=""><?php _e('seasons','cactusthemes');?></a></div>
                                              <div class="navi-item <?php if((isset($_GET['view']) && $_GET['view'] =='videos')){?> active <?php }?>"><a href="<?php echo add_query_arg( array('view' => 'videos'), get_the_permalink() ); ?>" title=""><?php _e('videos','cactusthemes');?></a></div>
                                      ...
                                      <div class="open-tab-menu">
                                        ...
                                        <div class="navi-sub-content">
                                              <div class="navi-sub-item <?php if( (!isset($_GET['view']) &&  ($cpage =='')) || ( (isset($_GET['view']) && $_GET['view'] =='playlists') &&  ($cpage =='')) || ((isset($_GET['view']) && $_GET['view'] =='')&&  ($cpage ==''))){?> active <?php }?>"><a href="<?php echo add_query_arg( array('view' => 'playlists'), get_the_permalink() ); ?>" title=""><?php _e('seasons','cactusthemes');?></a></div>
                                              <div class="navi-sub-item <?php if((isset($_GET['view']) && $_GET['view'] =='videos')){?> active <?php }?>"><a href="<?php echo add_query_arg( array('view' => 'videos'), get_the_permalink() ); ?>" title=""><?php _e('videos','cactusthemes');?></a></div>
