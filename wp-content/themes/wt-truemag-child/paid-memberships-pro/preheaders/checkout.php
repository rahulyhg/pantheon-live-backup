...
if ( pmpro_getOption( "gateway", true ) == "paytm" ) {
	$valid_gateways = apply_filters( "pmpro_valid_gateways", array( "paytm", "instamojo" ) );
} elseif ( pmpro_getOption( "gateway", true ) == "instamojo" ) {
	$valid_gateways = apply_filters( "pmpro_valid_gateways", array( "instamojo", "paytm" ) );
} else {
