...
?>
    ...
    <?php is_front_page() ? $menu_div_id = 'top-nav-invisible' : $menu_div_id = 'top-nav' ?>

    <div id="<?php echo $menu_div_id?>" class="<?php echo $topnav_style=='light'?'topnav-light light-div':'topnav-dark'; echo $fixed?' fixed-nav':''; echo ' '.$topnav_layout; ?>">
					...
					<div class="main-menu collapse navbar-collapse">
						...
						<ul class="nav navbar-nav hidden-xs nav-search-box">
                            <li class="main-menu-item">
								...
								<?php else: ?>
                                    <form class="<?php echo $topnav_style=='light'?'light-form':''; ?> dark-form" action="<?php echo home_url().'/all-videos/' ?>">
						...
						<?php
							...
							if($megamenu == 'on' && function_exists('mashmenu_load')){
								...
								// BJ: Toggle user menu based on user logged in
								if(is_user_logged_in()){
										$menu = 'custom-main-loggedin';
								}
								else{
										$menu = 'custom-main-anonymous';
								}
								wp_nav_menu(array(
                                                                        'menu' => $menu,
								...
								<li><a href="<?php echo home_url().'/all-videos/' ?>/"><?php _e('Home','cactusthemes') ?></a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="social-links col-md-6 col-sm-6">
                        ...
                        <?php 
						if($search_icon!=1){ ?>
                        <a class="search-toggle social-icon<?php echo $topnav_style=='dark'?' maincolor1 bordercolor1hover bgcolor1hover':''; echo $topnav_layout?' visible-xs':'' ?>" href="#"><i class="fa fa-search"></i></a>
